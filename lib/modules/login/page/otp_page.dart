  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          Center(
            child: Padding(
              padding: EdgeInsets.symmetric(horizontal: width(26), vertical: 0),
              child: RichText(
                text: TextSpan(
          ...
          Padding(
              padding: EdgeInsets.symmetric(vertical: 0, horizontal: 16.h),
              child: PinCodeTextField(
                ...
                pinTheme: PinTheme(
                  ...
                  selectedColor: greenMoney,
                  inactiveColor: greenMoney,
          ...
          Obx(()=> Center(
            child: Text(
              "0: " + controller.countDownTime.value.toString(),
              style: TextStyle(
                fontSize: 12.sp,
                color: const Color(0xff094496),
                fontStyle: FontStyle.normal,
            ...
            onTap: () async {
              if (controller.countDownTime.value == 0) {
                ...
                if (response == true) {
                  ...
                  CommonUtil.showToast("Có lỗi xảy ra, vui lòng thử lại");
                }
              } else {
                CommonUtil.showToast("Mã OTP đã được gửi. Vui lòng kiểm tra");
              }
            },
            child: (controller.countDownTime.value == 0)
                ? RichText(
                    text: TextSpan(
          ...
          Obx(
            () => buttonSendOTP(
                controller.otp.value.length == 6 ? greenMoney : grey_3),
          ),
          SizedBox(
            height: 35.h,
          ),
