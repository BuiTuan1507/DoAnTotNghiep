...
class ProductDetailPage extends GetView<ProductDetailController> {
          ...
          child: Column(
            children: [
              Obx(() => controller.isLoading.value
                  ? Expanded(child: loadingLogin(controller.isLoading.value))
                  : Expanded(
        ...
        builder: (BuildContext context) {
          return Column(
            ...
            children: [
              ...
              buildItemOptionalAppbar(() {
                Get.toNamed(RouterLink.reportPostPage,
                    arguments: controller.detailPostModel.value.post?.id);
              }, "Báo cáo bài đăng", Icons.report_problem_outlined),
              buildItemOptionalAppbar(() {
                Get.back();
              }, "Lưu tin", Icons.post_add_rounded),
              buildItemOptionalAppbar(() {
                Get.back();
              }, "Chia sẻ bài viết", Icons.share),
              SizedBox(
                height: height(40),
              )
            ],
  ...
  Widget buildItemOptionalAppbar(
      VoidCallback onClick, String tittle, IconData iconData) {
    return InkWell(
      onTap: onClick,
      child: Container(
        padding:
          ...
          Flexible(
              ...
              child: InkWell(
                  ...
                  child: buildItemBottomBar(
                      "Mua ngay", Icons.add_shopping_cart_rounded))),
        ],
      ),
    );
  }
            ...
            children: [
              Flexible(
                ...
                child: buildItemStatusDetailPage(
                    controller.detailPostModel.value.post?.liked.toString() ??
                        "0",
              ...
              Flexible(
                flex: 1,
                child: buildItemStatusDetailPage(
                    (controller.detailPostModel.value.post?.watch ?? 0)
                        .toString(),
  ...
  Widget buildItemStatusDetailPage(
      String tittle, IconData iconData, VoidCallback onClick) {
    return InkWell(
      onTap: onClick,
      child: Container(
        padding:
        ...
        children: [
          Obx(() => Row(
                children: [
                  Expanded(
                    child: Text(
                      controller.detailPostModel.value.post?.tittle ?? "",
                ...
                children: [
                  Expanded(
                    child: Padding(
                      ...
                      child: Text(
                        CommonUtil.formatMoney(
                            controller.detailPostModel.value.post?.money ?? 0),
          ...
          Obx(() => Row(
                ...
                children: [
                  ...
                  Text(
                    controller.detailPostModel.value.userPostData?.address ??
                        "",
                    style: AppStyles.textSmallDarkRegular,
                  )
                ],
          ...
          child: Row(
            ...
            children: [
              SizedBox(
                  ...
                  width: width(60),
                  child: buildAvatar(
                      controller.detailPostModel.value.userPostData?.avatar ??
                        ...
                        children: [
                          Row(
                            children: [
                              Expanded(
                                  child: Text(
                                (controller.detailPostModel.value.userPostData
                                            ?.firstName ??
                                        "") +
                                    " " +
                                    (controller.detailPostModel.value
                                            .userPostData?.lastName ??
                                        ""),
                                style: AppStyles.textSmallBlackMedium,
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis,
                          ...
                          Container(
                            ...
                            child: Center(
                              ...
                              text: TextSpan(
                                ...
                                children: <TextSpan>[
                                  TextSpan(
                                    text: controller.detailPostModel.value
                                            .userPostData?.lengthOfPost
                                            .toString() ??
                                        "0",
                                    style: AppStyles.textTinyDarkRegular,
                                  ),
                            ...
                            onTap: () {
                              Get.toNamed(RouterLink.watchUserPage,
                                  arguments: controller
                                      .detailPostModel.value.userPostData);
                            },
                            child: Container(
                              padding: EdgeInsets.symmetric(
                                  vertical: height(4), horizontal: width(6)),
              ...
              RichText(
                text: TextSpan(
                  ...
                  children: <TextSpan>[
                    TextSpan(
                      text: controller
                              .detailPostModel.value.post?.conditionOfUse ??
                          "",
                      style: AppStyles.textSmallGreenSemiBold,
                    ),
                  ],
              ...
              RichText(
                text: TextSpan(
                  ...
                  children: <TextSpan>[
                    TextSpan(
                      text:
                          controller.detailPostModel.value.post?.formUse ?? "",
                      style: AppStyles.textSmallGreenSemiBold,
                    ),
                  ],
                ),
  ...
  Widget buildItemSupportChat(String tittle) {
    return InkWell(
      onTap: () {
        controller.addPatternMessage(tittle);
      },
      child: Container(
        margin: EdgeInsets.only(right: width(10)),
        padding:
            EdgeInsets.symmetric(horizontal: width(12), vertical: height(8)),
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(20),
